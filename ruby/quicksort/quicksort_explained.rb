# Create quicksort base function that takes in an input array
def quick_sort (input_array)
  # Call the quick sort helper (created below) and pass it our input array, start index (0), and end index (input_array.length - 1)
  quick_sort_helper(input_array, 0, input_array.length - 1)
  # Return our input_array after quick sort helper finishes with it
  return input_array
end
