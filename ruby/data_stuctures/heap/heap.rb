class Heap
  ...
  def delete
    ...
    while has_greater_child(trickle_node_index)
      ...
      larger_child_index = calculated_larger_child_index(trickle_node_index)
  ...
  def has_greater_child(index)
    # We check whether the node at index has left and right children and if either of those children are greater than the node at index:
  ...
  def calculated_larger_child_index(index)
